...
import { createFixtureFilename, extractUrlPattern } from "../capture/url-pattern.js";
...
export async function generateServerManifest(
  ...
  for (const fixture of fixtures) {
    try {
      const filename = createFixtureFilename(fixture.request.method, fixture.request.pattern);
  ...
  const manifest: ServerManifest = {
    ...
    static: {
      ...
      entrypoint: entrypoint?.localPath || "index.html",
...
export function buildFixtureIndex(fixtures: ApiFixture[]): FixtureIndex {
  ...
  for (const fixture of fixtures) {
    ...
    entries.push({
      id: fixture.id,
      file: createFixtureFilename(fixture.request.method, fixture.request.pattern),
      method: fixture.request.method,
      pattern: fixture.request.pattern,
      params: fixture.request.params,
      priority,
